...
%%{
    ...
    include parser "dsmr_parser_tools.rl";
    ...
    action E_in_t1 { DEBUG("Energy in, tariff 1: %f %s\n", (double)fsm->arg[0] / (double)fsm->arg[1], fsm->strarg[0]); }
    action E_in_t2 { DEBUG("Energy in, tariff 2: %f %s\n", (double)fsm->arg[0] / (double)fsm->arg[1], fsm->strarg[0]); }
    action E_out_t1 { DEBUG("Energy out, tariff 1: %f %s\n", (double)fsm->arg[0] / (double)fsm->arg[1], fsm->strarg[0]); }
    action E_out_t2 { DEBUG("Energy out, tariff 2: %f %s\n", (double)fsm->arg[0] / (double)fsm->arg[1], fsm->strarg[0]); }
